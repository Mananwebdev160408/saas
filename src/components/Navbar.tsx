      ...
      >
        ...
        >
          ...
          <div className="flex gap-2 sm:gap-4 items-center">
            ...
            <Link className="bg-white text-black px-4 sm:px-7 py-2 rounded-full text-xs sm:text-sm font-black transition-all hover:scale-105 active:scale-95 whitespace-nowrap shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]" href="/signup">Start Free Trial</Link>
